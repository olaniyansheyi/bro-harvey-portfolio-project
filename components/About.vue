<template>
  <div class="sm:my-16 my-10 text-center px-8 w-full">
    ...
    >
      ...
      at the AGH University of Science and Technology in Krakow. I have been
      learning Front-End technologies for a year and this time was just enough
      for me to make sure that this is my place in the industry.
    </p>
    <p
      class="text-[#000000] text-left tracking-wider mt-5 sm:text-center lg:w-[55%] lg:mx-auto"
    >
    ...
    <button
      class="mt-10 border-x-2 border-[#000000] py-1 px-3 text-sm font-semibold"
    >
      EXPLORE
    </button>
